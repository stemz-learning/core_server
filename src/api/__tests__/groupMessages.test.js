...
describe('Group Messages API', () => {
  ...
  beforeAll(async () => {
    ...
    teacher = await User.create({ name: 'Teacher', email: 't2@t.com', password: 'pass', role: 'teacher' });
    student = await User.create({ name: 'Stu', email: 'stu@t.com', password: 'pass', role: 'student', gradeLevel: 3 });
