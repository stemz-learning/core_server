...
router.get("/", classroomController.getAllClassroomsWithIDs); // Get all classrooms
...
router.post("/:id/enroll", classroomController.enrollInClassroom); // Enroll in a classroom by ID
router.post("/:id/unenroll", classroomController.unenrollFromClassroom); // Unenroll from a classroom by ID
