...
const getQuizPredictions = async (req, res) => {
  ...
  //  testing quiz predictions with fake data
  // const getQuizPredictions = async (req, res) => {
  //   try {
  //     console.log("=== Quiz Predictions Debug Start ===");
  //     const { studentId } = req.params;
  ...
  //     // ======= TEMPORARILY SKIP GRADIO API CALL =======
  //     console.log("Skipping Gradio API call - returning dummy predictions");
  ...
  //       inputScores,
  //       predictions: {
  //         predicted_scores: [75, 80, 85],  // dummy predicted quiz scores
  //       },
  //       completedQuizzes: allQuizzes.length,
  //       totalQuizzesExpected: 5,
  //       chartData: [
  //         { quiz: 'Quiz 1', type: 'Completed', score: Math.round(inputScores[0]) },
  //         { quiz: 'Quiz 2', type: 'Completed', score: Math.round(inputScores[1]) },
  //         { quiz: 'Quiz 3', type: 'Predicted', score: 75 },
  //         { quiz: 'Quiz 4', type: 'Predicted', score: 80 },
  //         { quiz: 'Quiz 5', type: 'Predicted', score: 85 }
  //       ]
  //     };
  ...
  //     /*
  //     // Your original Gradio API calls code here - commented out for now
  
  //     // Step 1: POST request to get EVENT_ID with timeout
  //     // ...
  
  //     // Step 2: GET request with retry loop
  //     // ...
  //     */
